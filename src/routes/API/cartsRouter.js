...
const router = Router();
const { addCart, getCartById, updateCart, addProductToCart, updateProductQuantity, deleteProductsFromCart, deleteAllProducts, purchaseProducts } = new cartController();
...
// Método(petición) POST para finalizar la compra
