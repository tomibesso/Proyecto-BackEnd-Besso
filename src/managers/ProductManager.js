...
export default class ProductManager {
    constructor(path) {
        ...
        this.path = path;
        this.readProductFile(); // Lee el archivo de productos al instanciar la clase
    }
    ...
    addProduct(title, description, price, thumbnails, code, stock, category) { // Recibe por parametros las propiedades/campos del producto
    ...
    updateProduct(id, updateData) { // Recibe por parámetro
    ...
    deleteProduct(id) {
        ...
        this.saveProductFile(); // Guarda el archivo de nuevo pero sin el producto eliminado
